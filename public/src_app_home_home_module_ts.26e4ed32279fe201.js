...
class MarijuanaComponent {
    constructor(productService) {
        ...
        this.themeFooterLogo = 'assets/images/icon/logo-3.png';
        this.products = [];
